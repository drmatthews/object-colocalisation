...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.overlap_spinbox = QtGui.QSpinBox(self.verticalLayoutWidget)
        ...
        self.widget = QtGui.QWidget(self.movie_tab)
        self.widget.setGeometry(QtCore.QRect(600, 540, 429, 57))
        self.widget.setObjectName(_fromUtf8("widget"))
        self.horizontalLayout_10 = QtGui.QHBoxLayout(self.widget)
        self.horizontalLayout_10.setObjectName(_fromUtf8("horizontalLayout_10"))
        self.radio_groupbox = QtGui.QGroupBox(self.widget)
